...
import { 
  ...
  FaClock, FaCheckCircle, FaPauseCircle, FaBan, FaExclamationCircle
} from "react-icons/fa";
...
const ClientSupportPage = () => {
  ...
  const fetchClientTickets = async () => {
    ...
    try {
      ...
      const { data } = await axios.get("http://localhost:5000/api/client/support", {
        ...config,
        params: params
      });
  ...
  const currentData = filteredTickets.slice(startIndex, startIndex + entriesPerPage);
      ...
      <div className="bg-gray-100 min-h-screen p-4">
        <div className="max-w-md mx-auto mt-20 p-6 bg-white rounded-lg shadow-md">
          <div className="text-red-600 text-center">
            <h2 className="text-xl font-bold mb-4">Error Loading Support Tickets</h2>
              ...
              {currentData.length > 0 ? (
                currentData.map((ticket) => (
                  ...
                  >
                    ...
                    <td className="p-3 border-0">{formatDateTime(ticket.created)}</td>
                ...
                <tr>
                  <td colSpan={compactView ? 6 : 8} className="p-8 text-center">
                    <div className="text-gray-500">
                      ...
                      <p className="text-sm">
                        {searchTerm || statusFilter !== "All" 
                          ...
                          : "You don't have any support tickets yet. Tickets will appear here once they are created for your account."
                        }
                      </p>
                      {(searchTerm || statusFilter !== "All") && (
                        <button
