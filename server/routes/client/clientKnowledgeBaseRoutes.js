...
router.route("/").get(clientProtect, getClientArticles);

router.route("/:articleId/vote").post(clientProtect, voteOnArticle);

router.route("/user-votes").post(clientProtect, getUserVotes);
